...
/**
 * This class can be used to apply MINAS to the SynD dataset. If you are
...
public class SynD {
    ...
    public static final String[] DATASET = new String[]{"./datasets/SynD.csv"};
    public static final int TRAINING_DATA_SIZE = 25000;
