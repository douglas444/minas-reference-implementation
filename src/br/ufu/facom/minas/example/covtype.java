...
public class covtype {
    ...
    public static final String[] DATASET = new String[]{
            "./datasets/covtype-1.csv",
            "./datasets/covtype-2.csv",
            "./datasets/covtype-3.csv"
    };
    ...
    public static final int K_MEANS_K = 50;
    public static final double DECISION_RULE_FACTOR = 2;
    public static final int TEMPORARY_MEMORY_MAX_SIZE = 4000;
